...
let recorriendo=miforeach(arreglo,function callback(element)
{return element;}
);
...
function miMap(arr, fn) {
  ...
  let recorriendomap=miMap(arreglonum,function callback(element)
  {return element *10;}
  );
...
function miFilter(arr, fn) {
  ...
  console.log("Ejercicio 03-filter",recorriendofilter); 
